...
const Modal = () => {
    ...
    const submitForm = async (values) => {
        ...
        setLoading(true)
        const { data } = await axios.post(`${url}/api/driver/add-vehicle`, { values, img })
        setLoading(false)
        data.status ? toast.success("Vehicle Added") : toast.error("somthing wrong please try again");
                                ...
                                {loading ? (
                                    ...
                                    <>
                                        ...
                                        <input
                                            ...
                                            {...register('reg_no')}
                                        />
                                        <p className="mb-4 text-red-600">{errors.reg_no?.message}</p>
                                        {img &&
                                            <img src={img[0]} className='w-7' alt="" />
                                        }
                                        ...
                                        {img &&
                                            <img src={img[1]} className='w-7' alt="" />
                                        }
