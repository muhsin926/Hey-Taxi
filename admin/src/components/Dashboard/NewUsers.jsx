...
const NewUsers = () => {
  ...
  return (
    <div className="grid grid-cols-12 gap-5 p-3">
      <div className="col-span-12 md:col-span-6  bg-gradient-to-r to-zinc-800 from-black  p-7 rounded-lg ">
        <div>
          <div>
            ...
            <div className="flex  items-center gap-2 hover:bg-zinc-800 border-b rounded-md p-2 border-zinc-800 py-2">
              ...
              {!user.verify && (
                <div className="w-full text-end">
                  <button className="cursor-pointer bg-gradient-to-r from-green-500 to-green-900 rounded-md text-sm  ">
                    Verify Account
                  </button>
                </div>
              )}
