...
const HowToRide = () => {
    return (
        <section className='md:ml-12 md:mr-12 md:mb-12 md:p-10 ml-6 mr-6  p-5 '>
            <h1 className='md:text-3xl sm:text-3xl font-semibold'>How to ride with hey taxi</h1>
                    ...
                    <div className=' mt-0.5 '>
                        ...
                        <div>
                            <div className="flex -mt-2">
                                <div className=' '>
                                    <div className={`${index == howToRide.length-1 ? 'hidden' : null} w-0.5 h-40 bg-stone-700 ml-0.5 -mt-0.5`}></div>
                                </div>
