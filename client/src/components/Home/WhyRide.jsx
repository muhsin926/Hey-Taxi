...
const squareVariants = {
    visible: { opacity: 1, y: 1, transition: { duration: .5 } },
    hidden: { opacity: 0, y: "-4vw" }
};


const squareVariants1 = {
    visible: { opacity: 1, y: 1, transition: { duration: .5, delay: .5 } },
    hidden: { opacity: 0, y: "-4vw" }
};
const WhyRide = () => {
    ...
    return (
        <section className='md:m-12 md:p-10 m-6 p-5  bg-white'>
            <motion.h1
                ...
                className='md:text-3xl sm:text-3xl font-semibold '>Why ride with hey taxi</motion.h1>
